...
class FAQMatcher:
    ...
    def match(self, query: str) -> Optional[FAQMatch]:
        ...
        if best is None or best_score < threshold:
            # Spec query-processor delta:50-54: en miss también se loggea
            # para que el operador pueda ver el mejor score y calibrar
            # el threshold. matched_id=None, returned=False.
            miss_score = round(best_score, 4) if best is not None else 0.0
            self.logger.info(
                "FAQ match attempt",
                score=miss_score,
                matched_id=None,
        ...
        # Spec query-processor delta:44-48: en hit se loggea con el id
        # de la fila matcheada y returned=True.
        self.logger.info(
            "FAQ match attempt",
